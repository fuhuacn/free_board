var UploadAvatarModal = function(option) {
    ...
    var template = ['<div class="modal fade" id="front-modal-upload-avatar" tabindex="-1">',
        ...
        '<li class="active">',
        '<a href="#freeshare-diyImg" action-toggle="tab">自定义图标</a>',
        '</li>',
        '<li>',
        '<a href="#freeshare-systemImg" action-toggle="tab">系统图标</a>',
        '</li>',
        '</ul>',
    ...
    var tailTemplate = ['</div>',
        ...
        '<a href="#" class="btn btn-default" action-dismiss="modal">取消</a>',
