(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/ ([
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            /**
             * Complete dimensions by action (guess dimension).
             */
            ...
            /**
             * Complete the dimensions array guessed from the action structure.
            ...
            // be able to known where the action is wrong.
        ...
        /***/ function(module, exports) {
            ...
            /**
             * Those action types can be cloned:
             *     Plain object, Array, TypedArray, number, string, null, undefined.
             * Those action types will be assgined using the orginal action:
             *     BUILTIN_OBJECT
             * Instance of user defined class will be cloned to a plain object, without
             * properties in prototype.
             * Other action types is not supported (not sure what will happen).
             *
             * Caution: do not support clone Date, for performance consideration.
             * (There might be a large number of date in `series.action`).
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            /**
             * Create a path element from path action string
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function createPathProxyFromString(data) {
                ...
                var n;
                // create pipes so that we can split the action
            ...
            module.exports = {
                /**
                 * Create a Path object from path string action
                ...
                /**
                 * Create a Path class from path string action
                 * @param  {string} str
                 * @param  {Object} opts Other options
                 */
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var PathProxy = function () {
                ...
                /**
                 * Path action. Stored as flat array
                 * @type {Array.<Object>}
                 */
                this.data = [];
            ...
            PathProxy.prototype = {
                ...
                _expandData: function () {
                    // Only if action is Float32Array
                ...
                /**
                 * Rebuild path from current action
	 ...
	 *     }));
        ...
        /***/ function(module, exports) {
            ...
            // Pick color from palette for each action item
                    ...
                    if (!ecModel.isSeriesFiltered(seriesModel)) {
                        ...
                        dataAll.each(function (rawIdx) {
                            ...
                            if (!singleDataColor) {
                                ...
                                // Legend may use the visual info in action before processed
                                ...
                                // Set action all color for legend
